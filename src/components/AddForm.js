...
import { addSmurfs, errorAdd} from '../actions/index';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.errorAdd("Name, position and nickname fields are required.")
        }else {
            props.addSmurfs(state.name, state.nickname, state.position, state.description)
        }
    }
...
export default connect(mapStateToProps, { addSmurfs, errorAdd })(AddForm)
